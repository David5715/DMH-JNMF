...
This repository contains the official implementation of the paper: "Deep Multi-Head Attention Joint NMF for Non-linear Multi-Modal Fusion in Alzheimer's Disease".
